 ...
 */
export async function getProjectAssets(_projectId: string): Promise<BrandAssets> {
  // TODO: Real API call - projectId will be used when connecting to real PM API
 ...
 */
export async function getProjectCopy(_projectId: string): Promise<CopyAssets> {
  // TODO: Real API call - projectId will be used when connecting to real PM API
  return getMockCopy();
}
...
function getMockBrandDNA(): BrandDNA {
  return {
    ...
    idealCustomer:
      "Busy professionals aged 25-45 who want to eat healthy but don't have time to meal plan or grocery shop.",
    problemSolved:
      'We eliminate the stress of figuring out what to eat, grocery shopping, and meal prep - saving our customers 5-10 hours per week.',
    desiredTransformation:
      'They want to feel healthier, have more energy, and spend less time thinking about food so they can focus on what matters.',
    offering:
      'Weekly meal kit subscription with pre-portioned ingredients and 15-minute recipes. Plans start at $79/week.',
    differentiators:
      'Unlike meal delivery services, we teach you to cook. Our recipes are designed for real people - no fancy equipment, no obscure ingredients. Plus, everything is customizable for dietary restrictions.',
    ...
    salesProcess:
      'They sign up for a free recipe guide, then we nurture them with emails showing how easy our meals are to make. Most convert within 2 weeks.',
    objections: "Some think meal kits are too expensive or that they won't actually cook the meals.",
    socialProof:
      "Over 10,000 meals delivered. 4.8 stars on Trustpilot. Featured in Women's Health and Good Housekeeping.",
...
function getMockCopy(): CopyAssets {
  return {
    ...
    offers: ['First Week 50% Off - No Commitment', 'Free Recipe Guide + $20 Off Your First Box'],
    adCopy: ["Tired of the 'what's for dinner?' panic at 6pm? We've got you."],
  };
}
  ...
  return [
    {
      id: 'test-1',
      quote:
        "I've tried every meal kit out there. FreshPlate is the only one I've stuck with for more than a month. The recipes are actually doable after a long day.",
      author: 'Sarah M.',
    ...
    },
    {
      id: 'test-2',
      quote:
        'My husband and I used to spend $200/week eating out because we were too tired to cook. Now we cook together 4 nights a week and actually enjoy it.',
      author: 'Jennifer K.',
    ...
    },
    {
      id: 'test-3',
      quote:
        'Lost 15 pounds in 3 months without feeling like I was on a diet. The portions are perfect and the food actually tastes good.',
      author: 'Mike T.',
