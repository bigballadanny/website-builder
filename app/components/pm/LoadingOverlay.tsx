    ...
    <>
      ...
      >
        ...
        <div className="relative w-[100px] h-[100px] mb-10">
          ...
          >
            <img src="/pm-logo-white.png" alt="Pocket Marketer" className="w-full h-full object-contain" />
          </div>
        </div>

        {/* Message */}
        <h2 className="text-2xl font-bold text-white mb-2 text-center tracking-tight">{message}</h2>

        {/* Stage Label */}
        {stage && <p className="text-base text-purple-500 mb-6 text-center font-medium">{stage}</p>}
        ...
        <div className="absolute bottom-6 flex items-center gap-2 text-xs text-zinc-600">
          Press <span className="px-2 py-1 bg-zinc-900 border border-zinc-800 rounded font-mono text-[11px]">Esc</span>{' '}
          to cancel
        </div>
      </div>
    </>
